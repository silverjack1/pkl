    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="header.php.html" method="post" enctype="multipart/form-data"
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBl5Jp7BMT3NWY0P1M7VzHMFAA8uQAo3BU"></script>
