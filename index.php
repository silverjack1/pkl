...
} else if ($_SESSION && isset($_GET["tambahsoaltabel"])) {
    if ($_SESSION['status'] == 'guru' or $_SESSION['status'] == 'admin') {
        include "detailsoal/soaltabel/tambahsoaltabel.php";
    } else {
        echo "<script>window.history.go(-1);</script>";
    }
} else if ($_SESSION && isset($_GET["editsoaltabel"])) {
    if ($_SESSION['status'] == 'guru' or $_SESSION['status'] == 'admin') {
        include "detailsoal/soaltabel/editsoal.php";
    } else {
        echo "<script>window.history.go(-1);</script>";
    }
