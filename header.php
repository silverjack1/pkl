...
<head>
    ...
    <title>Latihan ANBK SDN Tomang 03</title>
                        ...
                        <div class="sidebar-section">
                            ...
                            <div class="alert alert-success alert-alt">
                                ...
                                <i class="fa fa-plus fa-fw"></i> <a
                                    href="page_ready_user_profile.html"><strong><?php echo $_SESSION['username']; ?></strong></a>
                                would like to become friends!<br>
                            ...
                            <div class="alert alert-warning alert-alt">
                                ...
                                <a href="page_ready_pricing_tables.html" class="btn btn-xs btn-primary"><i
                ...
                <div id="sidebar-scroll">
                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="sidebar-brand">
                            <span class="sidebar-nav-mini-hide">SDN Tomang 03</span>
                        </div>
                        <!-- END Brand -->
                        ...
                        <ul class="sidebar-nav">
                            ...
                            <!-- menu admin -->
                            <li>
                                <a href="index.php?home"><i class="gi gi-stopwatch sidebar-nav-icon"></i><span
                            ...
                            <li>
                                <a href="index.php?soal"><i class="gi gi-more_items sidebar-nav-icon"></i><span
                                        class="sidebar-nav-mini-hide">Group Soal</span></a>
                            </li>
                            <!--<li>
                                    <a href="index.php?ujian"><i class="gi gi-cogwheel sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Set Ujian</span></a>
                                </li>-->
                            <li>
                                <a href="index.php?rekapnilaiujian"><i class="gi gi-cup sidebar-nav-icon"></i><span
                                        class="sidebar-nav-mini-hide">Nilai</span></a>
                            </li>
                            <li>
                                <a href="index.php?user"><i class="gi gi-user sidebar-nav-icon"></i><span
                                        class="sidebar-nav-mini-hide">User</span></a>
                            </li>
                            <li>
                                <a href="logout.php"><i class="gi gi-left_arrow sidebar-nav-icon"></i><span
                            ...
                            <li>
                                <a href="index.php?soal"><i class="gi gi-more_items sidebar-nav-icon"></i><span
                                        class="sidebar-nav-mini-hide">Soal</span></a>
                            </li>
                            <li>
                                <a href="index.php?ujian"><i class="gi gi-cogwheel sidebar-nav-icon"></i><span
                                        class="sidebar-nav-mini-hide">Set Ujian</span></a>
                            </li>
                            <li>
                                <a href="index.php?rekapnilaiujian"><i class="gi gi-cup sidebar-nav-icon"></i><span
                                        class="sidebar-nav-mini-hide">Nilai</span></a>
                            ...
                            <li>
                                <a href="index.php?daftarujian"><i class="gi gi-more_items sidebar-nav-icon"></i><span
                                        class="sidebar-nav-mini-hide">Daftar Ujian</span></a>
                            </li>

                            <li>
                                <a href="index.php?hasilujian"><i class="gi gi-cup sidebar-nav-icon"></i><span
                                        class="sidebar-nav-mini-hide">Nilai</span></a>
                            </li>
                            <li>
                                <a href="logout.php"><i class="gi gi-left_arrow sidebar-nav-icon"></i><span
