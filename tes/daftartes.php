...
<div class="block full">
    ...
    <div class="block-title">
        <div class="block-options pull-right">
            Sisa Waktu <a href="javascript:void(0)" class="btn btn-sm btn-alt btn-default">
                <div id='timer'></div>
    ...
    <form action="tes/proseseditjawaban.php" method="post">
        ...
        <table>
            ...
            <tr>
                <td><input width="100" class="form-control" type="text" name="pilihan[]"
                        value="<?php echo $data['jawaban']; ?>"></td>
            </tr>
        </table>
        <br>
        <br>
        <?php } elseif ($data['jenissoal'] == 'soaltabel') { ?>
        <?php $tabel = explode(', ', $data['jawaban']); ?>
        <table>
            <tr>
                <td colspan="2">
                    <p><?php echo $data['soal']; ?></p>
        ...
        <input type="hidden" name="soaltabel" value="soaltabel">
        <table class="table table-bordered">
            <tr>
                <td class="label-primary text-center" style="width: 20px;"><strong>No</strong></td>
                <td class=" label-primary text-center"><strong>Pernyataan</strong></td>
                <td class="label-primary text-center col-md-1"><strong>Benar</strong></td>
                <td class="label-primary text-center col-md-1"><strong>Salah</strong></td>
            </tr>

            <?php if (isset($data['jawaban'])) : ?>
            <?php $pilih = explode(', ', $data['jawaban']); ?>
            <tr>
                <td>1</td>
                <td><?= $data['pilihana'] ?></td>
                <td>
                    <center>
                        <input type="radio" name="jawaban1" value="B" <?= $pilih[0] == "B" ? "checked" : ""; ?>>
                    </center>
                </td>
                <td>
                    <center>
                        <input type="radio" name="jawaban1" value="S" <?= $pilih[0] == "S" ? "checked" : ""; ?>>
                    </center>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <center>
                        <input type="radio" name="jawaban2" value="B" <?= $pilih[1] == "B" ? "checked" : ""; ?>>
                    </center>
                </td>
                <td>
                    <center>
                        <input type="radio" name="jawaban2" value="S" <?= $pilih[1] == "S" ? "checked" : ""; ?>>
                    </center>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <center>
                        <input type="radio" name="jawaban3" value="B" <?= $pilih[2] == "B" ? "checked" : ""; ?>>
                    </center>
                </td>
                <td>
                    <center>
                        <input type="radio" name="jawaban3" value="S" <?= $pilih[2] == "S" ? "checked" : ""; ?>>
                    </center>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <center>
                        <input type="radio" name="jawaban4" value="B" <?= $pilih[3] == "B" ? "checked" : ""; ?>>
                    </center>
                </td>
                <td>
                    <center>
                        <input type="radio" name="jawaban4" value="S" <?= $pilih[3] == "S" ? "checked" : ""; ?>>
                    </center>
                </td>
            </tr>
            <?php else : ?>
            <tr>
                ...
                <td>
                    <center>
                        <input type="radio" name="jawaban1" value="B">
                    </center>
                </td>
                <td>
                    <center>
                        <input type="radio" name="jawaban1" value="S">
                    </center>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <center>
                        <input type="radio" name="jawaban2" value="B">
                    </center>
                </td>
                <td>
                    <center>
                        <input type="radio" name="jawaban2" value="S">
                    </center>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <center>
                        <input type="radio" name="jawaban3" value="B">
                    </center>
                </td>
                <td>
                    <center>
                        <input type="radio" name="jawaban3" value="S">
                    </center>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <center>
                        <input type="radio" name="jawaban4" value="B">
                    </center>
                </td>
                <td>
                    <center>
                        <input type="radio" name="jawaban4" value="S">
                    </center>
                </td>
            </tr>
            <?php endif; ?>
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td width=36 valign=top style='width:27.15pt;padding:0cm 5.4pt 0cm 5.4pt'>
                    <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
            150%'><span style='font-family:"MS Mincho"'>
                            <input type="checkbox" <?php in_array('a', $checked) ? print "checked" : ""; ?>
                                name="pilihan[]" value="a"></span></p>
                </td>
                <td width=554 valign=top style='width:415.25pt;padding:0cm 5.4pt 0cm 5.4pt'>
                    <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
            150%'><span style='font-family:"Times New Roman","serif"'><?php echo $data['pilihana']; ?></span></p>
            ...
            <tr>
                <td width=36 valign=top style='width:27.15pt;padding:0cm 5.4pt 0cm 5.4pt'>
                    <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
            150%'><span style='font-family:"MS Mincho"'>
                            <input type="checkbox" <?php in_array('b', $checked) ? print "checked" : ""; ?>
                                name="pilihan[]" value="b"></span></p>
                </td>
                <td width=554 valign=top style='width:415.25pt;padding:0cm 5.4pt 0cm 5.4pt'>
                    <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
            150%'><span style='font-family:"Times New Roman","serif"'><?php echo $data['pilihanb']; ?></span></p>
            ...
            <tr>
                <td width=36 valign=top style='width:27.15pt;padding:0cm 5.4pt 0cm 5.4pt'>
                    <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
            150%'><span style='font-family:"MS Mincho"'>
                            <input type="checkbox" <?php in_array('c', $checked) ? print "checked" : ""; ?>
                                name="pilihan[]" value="c">
                </td>
                <td width=554 valign=top style='width:415.25pt;padding:0cm 5.4pt 0cm 5.4pt'>
                    <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
            150%'><span style='font-family:"Times New Roman","serif"'><?php echo $data['pilihanc']; ?></span></p>
            ...
            <tr>
                <td width=36 valign=top style='width:27.15pt;padding:0cm 5.4pt 0cm 5.4pt'>
                    <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
            150%'><span style='font-family:"MS Mincho"'>
                            <input type="checkbox" <?php in_array('d', $checked) ? print "checked" : ""; ?>
                                name="pilihan[]" value="d">
                </td>
                <td width=554 valign=top style='width:415.25pt;padding:0cm 5.4pt 0cm 5.4pt'>
                    <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
            150%'><span style='font-family:"Times New Roman","serif"'><?php echo $data['pilihand']; ?></span></p>
            ...
            <tr>
                <td width=36 valign=top style='width:27.15pt;padding:0cm 5.4pt 0cm 5.4pt'>
                    <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
            150%'><span style='font-family:"MS Mincho"'>
                            <input type="checkbox" <?php in_array('e', $checked) ? print "checked" : ""; ?>
                                name="pilihan[]" value="e">
                </td>
                <td width=554 valign=top style='width:415.25pt;padding:0cm 5.4pt 0cm 5.4pt'>
                    <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
            150%'><span style='font-family:"Times New Roman","serif"'><?php echo $data['pilihane']; ?></span></p>
                    ...
                    <form action="tes/prosesnilai.php" method="post">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <td><a href="http://localhost/pkl/index.php?tes=<?php echo $no - $x; ?>">Edit Jawaban<a>
                                </td>
                            </tr>
                            <?php
                                }
