...
?>
<a href="index.php?tambahsoalpilihanganda&idgroup=<?php echo $idgroup; ?>" title="Tambah Soal" class="btn btn-sm btn-info">Tambah</a>
...
<?php } ?>
                <a href="detailsoal/eksportexcel.php?idgroup=<?php echo $idgroup; ?>&jenissoal=singlechoice" title="Export Soal" class="btn btn-sm btn-success">Export Ke Excel</a>
            ...
            <div class="table-responsive">
                <table id="example-datatable" class="soalpilihanganda table table-striped">
                    ...
                    <tbody>
                        <?php
                        $no = 1;
                        $tampil = mysqli_query($mysqli, "select * from soal where jenissoal='singlechoice' and idgroup='$idgroup' ");
