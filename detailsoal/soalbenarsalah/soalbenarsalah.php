...
?>
<a href="index.php?tambahsoaltruefalse&idgroup=<?php echo $idgroup; ?>" title="Tambah Soal"
    class="btn btn-sm btn-info">Tambah</a>
<button type="reset" class="btn btn-sm btn-success" title="Import Soal"
    onclick="$('#modal-import-soalbenarsalah').modal('show');">Import dari Excel</button>
...
<?php } ?>
<a href="detailsoal/eksportexcel.php?idgroup=<?php echo $idgroup; ?>&jenissoal=truefalse" title="Export Soal"
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    <a title="Edit"
                        href="index.php?editsoalpilihanganda&idgroup=<?php echo $idgroup; ?>&idsoal=<?php echo $hasil['idsoal']; ?>"
                    ...
                    <a title="Delete" onclick="return confirm('apakah anda yakin ingin menghapus data? ');"
                        href="detailsoal/soalpilihanganda/proseshapus.php?idsoal=<?php echo $hasil['idsoal']; ?>&idgroup=<?php echo $hasil['idgroup']; ?>"
